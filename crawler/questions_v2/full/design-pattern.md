# 设计模式 / 面向对象
> 题目数量：**8** ｜ 生成时间：2026-09-19 ｜ 格式：固定五段（高频程度 / 考察点 / 回答框架 / 参考回答 / 常见追问）
...
> **高频程度**：★★☆☆☆　|　**原题 ID**：`q0976`　|　**标签**：`设计模式` `设计模式七大原则`

**考察点**：【由分类/标签推断】设计模式 / 面向对象 方向，重点考察 设计模式、设计模式七大原则 的理解与工程落地、边界场景的掌握。

**回答框架**：- 单例是一种更优雅、更可控的全局访问方式，适合需要全局唯一实例的场景
...
> **高频程度**：★★☆☆☆　|　**原题 ID**：`q0977`　|　**标签**：`设计模式` `单例模式`

**考察点**：【由分类/标签推断】设计模式 / 面向对象 方向，重点考察 设计模式、单例模式 的理解与工程落地、边界场景的掌握。

**回答框架**：- 在 init 函数中直接初始化 singleton 实例
...
> **高频程度**：★★☆☆☆　|　**原题 ID**：`q0979`　|　**标签**：`设计模式` `工厂模式`

**考察点**：【由分类/标签推断】设计模式 / 面向对象 方向，重点考察 设计模式、工厂模式 的理解与工程落地、边界场景的掌握。

**回答框架**：[23种设计模式之工厂模式](https://www.bilibili.com/…
...
> **高频程度**：★★☆☆☆　|　**原题 ID**：`q0980`　|　**标签**：`设计模式` `工厂模式`

**考察点**：【由分类/标签推断】设计模式 / 面向对象 方向，重点考察 设计模式、工厂模式 的理解与工程落地、边界场景的掌握。

**回答框架**：当对象的创建逻辑比较复杂，不只是简单的 new 一下就可以，而是要组合其他类对象…
...
> **高频程度**：★★★☆☆　|　**原题 ID**：`q0981`　|　**标签**：（无）

**考察点**：【由分类/标签推断】设计模式 / 面向对象 方向，重点考察 该主题 的理解与工程落地、边界场景的掌握。

**回答框架**：抽象工厂模式（Abstract Factory Pattern）是一种创建型设计…
...
> **高频程度**：★★☆☆☆　|　**原题 ID**：`q1752`　|　**标签**：`概念基础` `juejin`

**考察点**：【由分类/标签推断】设计模式 / 面向对象 方向，重点考察 概念基础、juejin 的理解与工程落地、边界场景的掌握。

**回答框架**：把 HTTP Client 按目标站点（host/域名）分组做成连接池，而不是全…
...
> **高频程度**：★★☆☆☆　|　**原题 ID**：`q3505`　|　**标签**：`概念基础` `nowcoder`

**考察点**：【由分类/标签推断】设计模式 / 面向对象 方向，重点考察 概念基础、nowcoder 的理解与工程落地、边界场景的掌握。

**回答框架**：抽象类表达“是什么”的继承关系，接口表达“能做什么”的能力契约；Java 中类单…
